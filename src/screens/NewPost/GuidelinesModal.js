      ...
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          <Text style={styles.modalText}>
            ...
            <Text style={styles.summary}>🛡️ Privacy Matters:</Text> Please don't share personal info like addresses or
            phone numbers.{"\n\n"}
            ...
            <Text style={styles.summary}>©️ Respect Copyright:</Text> Share what's yours or what you're allowed
            to{"\n\n"}
            <Text style={styles.summary}>🚩 Flag Concerns:</Text> See something that shouldn't be here? Let us
            know!{"\n\n"}
            <Text style={styles.summary}>🎉 Have Fun!</Text> Enjoy connecting with fellow pet lovers and their adorable
            companions!
          </Text>
